    ...
    <div className="flex flex-col  bg-outerBg-light text-Normal-light pb-6 dark:text-Normal-dark  dark:bg-outerBg-dark  w-full ">
      <div className="flex justify-center items-center w-full">
        <div className="flex flex-row test-color1 justify-between items-center py-1 px-5 w-[85%] tracking-wider">
          ...
          <ul className="my-2 px-16 py-4 rounded-full text-[14px] font-semibold hidden shadow-lg shadow-sky-700 hover:shadow-sky-900 lg:flex lg:items-center lg:gap-10 ">
            <a href="#home">Home</a>
            <a href="#Profile">Profile Summary</a>
            <a href="#about">About Me</a>
            <a href="#skills">Skills</a>
          ...
          <div className="flex justify-center items-center gap-3">
            <div className="flex justify-center items-center  lg:w-40 hover:text-lg">
              <button
                className="lg:flex lg:items-center lg:justify-center my-1 rounded-full shadow-lg border-[3px] cursor-pointer bg-slate-300 lg:w-auto  border-slate-900 shadow-sky-600 p-[3px] "
                onClick={handleTheme}
                ref={button1}
              >
                <div className=" ">
                  {mode === "dark" && (
                    <MdLightMode className="text-black text-2xl hover:text-3xl " />
                  )}
                  {mode === "light" && (
                    <MdDarkMode className="text-2xl hover:text-3xl" />
                  )}
                </div>
                <h1 className="text-slate-950 font-semibold hidden lg:block">
